  ...
  return (
    <React.Fragment>
       ...
       <main> 
        ...
        <div className={classNames(classes.layout, classes.cardGrid)}>
          ...
          <Grid container spacing={16} justify="left">
              ...
              Course 
                ...
                <Grid item>
                <Typography variant="subtitle1" align="left" color="textSecondary" style={{paddingTop:4}}>
              2018 Semester 1 
            </Typography>
                </Grid>
              </Grid>
        ...
        <Typography component="h1" variant="h5" align="left" color="textPrimary" gutterBottom style={{paddingTop:14}}>
              Recent Performance 
        </Typography>
