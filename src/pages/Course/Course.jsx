...
class Course extends React.Component {
  ...
  handleSearch = () => {
    getCourseList()
      .then(response => {
        ...
        courseData.map(item => {
          courseRows.push(
            createData(item.id, item.code, item.name, item.disabled)
          );
        });
  ...
  render() {
    ...
    return <Template title="Course Management">
        <React.Fragment>
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <CustomTableCell>
                        ...
                        <TextField id="standard-with-placeholder" label="" placeholder="Course Code" className={classes.textField} margin="normal" value={this.state.filter} onChange={this.handleFilter} />
                      </CustomTableCell>
                    </TableRow>
                  </TableHead>
                  {loading ? <TableBody>
                      ...
                      {rows.length === 0 ? "No results by your input,please correct the input" : rows
                            .slice(
                              page * rowsPerPage,
