...
let counter = 0;
function createData(teacherId, name, title, department, course, date_of_birth, gender, disabled, id) {
  counter += 1;
  return { counter, teacherId, name, title, department, course, date_of_birth, gender, disabled, id };
}
...
export default withStyles(styles)(ListTeacher);
